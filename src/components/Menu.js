...
export default function Menu(){
    ...
    return(
        <div id="menuCover">
            ...
            {linkliste.map((item,index)=>{
                return <LinkItem key={index} url={item.url} svg={item.svgikon} svg2={item.svgikon2} />
            })}
